...
eval env badform@(List [Atom "define"]) = 
    throwError $ BadSpecialForm "Missing var and value for define form" badform
eval env badform@(List [Atom "define", _]) = 
    throwError $ BadSpecialForm "Missing value for define form" badform
